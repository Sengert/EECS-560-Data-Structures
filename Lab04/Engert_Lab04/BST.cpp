...
void BST::Insert(int x){
        ...
        if(root == nullptr){
                ...
                root->value = x;
                cout << "[DEBUG] " << x << " has been insert as the BST's root value.\n";
                return;
        }
...
void BST::DeleteMin(Node* curNode){
        ...
        if(temp == root){
                ...
                root = temp->rightSubNode;
                temp->rightSubNode->parentNode = nullptr;
                delete temp;
                temp = nullptr;
                root = nullptr;
                return;
...
void BST::DeleteMax(Node* curNode){
        ...
        if(temp == root){
                cout << temp->value << " has been deleted\n";
                root = temp->leftSubNode;
                temp->leftSubNode->parentNode = nullptr;
                delete temp;
                temp = nullptr;
                root = nullptr;
                return;
